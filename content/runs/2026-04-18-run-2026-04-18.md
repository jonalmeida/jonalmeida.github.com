...
extra:
  ...
  hr_zones:
    ...
    - { zone: 4, name: "Threshold", pct: 1.4 }
    - { zone: 3, name: "Aerobic", pct: 34.3 }
    - { zone: 2, name: "Easy", pct: 18.9 }
    - { zone: 1, name: "Warm Up", pct: 45.4 }
---
...
{{ <image path="/runs/maps/22571725386.svg" width={640} /> }}
